# generator-yeoman-timwe-angular [![Build Status](https://secure.travis-ci.org/fateicha/generator-yeoman-timwe-angular.png?branch=master)](https://travis-ci.org/fateicha/generator-yeoman-timwe-angular)
